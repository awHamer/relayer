 ...
 */
export type InferEntityWhere<TClient, TEntity extends string> =
  TEntity extends keyof TClient
    ? TClient[TEntity] extends { findMany(options?: infer O): any }
 ...
 */
export type InferEntitySelect<TClient, TEntity extends string> =
  TEntity extends keyof TClient
    ? TClient[TEntity] extends { findMany(options?: infer O): any }
 ...
 */
export type InferEntityOrderBy<TClient, TEntity extends string> =
  TEntity extends keyof TClient
    ? TClient[TEntity] extends { findMany(options?: infer O): any }
